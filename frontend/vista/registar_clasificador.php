			...
			<div class="col-lg-6">
				<div class="app-card h-100">
					...
					<form id="form-clasificador" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            <label for="descripcion" class="form-label fw-semibold">Descripcion (opcional)</label>
                            <textarea name="descripcion" id="descripcion" class="form-control app-input" rows="3" placeholder="Detalles del rubro para el recibo"></textarea>
                        </div>
